...
<html lang="en">
  <head>
    ...
    <title>Continente - Países - Mínimos y Máximos</title>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="page-title">
              <div class="title">
                <h3>Por continente los países con los valores máximos/mínimos.</h3>
              </div>
            </div>
    ...
    <!-- JS For Followers -->
    <script src="js/contCountryMaxMinVar.js"></script>
  </body>
</html>
