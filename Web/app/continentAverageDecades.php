...
<html lang="en">
  <head>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="page-title">
              <div class="title">
                <h3>Por continente, el promedio de cada variable en grupos de diez años</h3>
              </div>
            </div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate id="filterForm" autocomplete="off">
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-1 col-sm-1 col-xs-12">Década</label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <select class="form-control" id="decades">
    ...
    <!-- JS For Followers -->
    <script src="js/continentAverageDecades.js"></script>
  </body>
</html>
