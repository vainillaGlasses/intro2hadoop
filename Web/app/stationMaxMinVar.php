...
<html lang="en">
  <head>
    ...
    <title>Máximos y Mínimos por Estación</title>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="page-title">
              <div class="title">
                <h3>Para cada país la estación en la que cada una de las variables fue la máxima/mínima</h3>
              </div>
            </div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate id="filterForm" autocomplete="off">
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-1 col-sm-1 col-xs-12">Estación</label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>Continente</th>
                          <th>País</th>
                          <th>Nombre de Estación o Región</th>
                          <th>Variable</th>
                          <th>Valor</th>
                          <th>Max/Min</th>
                        </tr>
    ...
    <!-- JS For Followers -->
    <script src="js/stationMaxMinVar.js"></script>
  </body>
</html>
