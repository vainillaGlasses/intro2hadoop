...
public class MinimumVarsCountry { 
   //Mapper class 
   ...
   VariableCountry>         /*Output value Type*/ 
   {
      ...
      Reporter reporter) throws IOException {
         ...
         // No nos interesa la estacion, las coordenadas ni el año, los desechamos
         s.nextToken();
         s.nextToken();
         s.nextToken();
         s.nextToken();
   ...
   public static void main(String args[]) throws Exception {
      ...
      JobConf conf = new JobConf(MinimumVarsCountry.class); 
      
      conf.setJobName("minimum_vars_country");
