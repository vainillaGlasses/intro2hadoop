...
public class TopTenMaxAverages extends Configured implements Tool {
   ...
   public static class TopTenReducer extends Reducer <Text, VariableCountry, Text, TopTenCountry> {
      ...
      private void insertIntoTreeMap(String country, float totalSum, int counted, TreeMap<Float, String> mapToInsert) {
    	  if (counted != 0) {
    		  ...
    		  if (mapToInsert.size() > 10) {
    			  mapToInsert.remove(mapToInsert.firstKey());
    		  }
    	  }
      }
      ...
      private TopTenCountry getTopTenFromMap(TreeMap<Float, String> inputMap) {
		  ...
		  Float[] indexList = inputMap.descendingKeySet().toArray(new Float[inputMap.size()]);
   ...
   public int run(String[] arg) throws Exception {      
      ...
      job.setJarByClass(TopTenMaxAverages.class);
   ...
   public static void main(String args[]) throws Exception {
	  ...
	  int response = ToolRunner.run(new Configuration(), new TopTenMaxAverages(), args);
